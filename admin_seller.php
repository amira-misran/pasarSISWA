      ...
      <table id="product-table" class="table table-striped table-bordered white-table">
        ...
        <tbody>
          ...
          try {
            ...
            $stmt = $conn->prepare("select * from tbl_seller_pasarsiswa");
            $stmt->execute();
          ...
          ?>
            <tr>
              <td><?php echo $readrow['fld_seller_id']; ?></td>
              <td><?php echo $readrow['fld_seller_name']; ?></td>
              <td><?php echo $readrow['fld_business_name']; ?></td>
              <td><?php echo $readrow['fld_seller_email']; ?></td>
              <td><?php echo $readrow['fld_seller_phonenumber']; ?></td>
