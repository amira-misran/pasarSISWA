...
if (isset($_GET['selected_month']) && isset($_GET['selected_year'])) {
    ...
    $end_date = "$selected_year-$selected_month-$last_day 23:59:59";
...
WHERE MONTH(o.fld_order_date) = $selected_month
AND YEAR(o.fld_order_date) = $selected_year";
...
$result = $conn->query($query);
    ...
    echo "<p>Please select both month and year from the admin menu.</p>";
}
?>
...
<body>
    ...
    <section class="table__body">
        ...
        <main class="table" id="customers_table" >
            <section class="table__header">
                <h1>Sales Reports for <?php echo $selected_month;?>/<?php echo $selected_year;?></h1>
