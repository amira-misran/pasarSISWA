...
function getOrders($conn, $sellerId) {
    ...
    $query = "SELECT * FROM tbl_order_pasarsiswa WHERE fld_order_status = 'Waiting Seller to accept' AND fld_seller_id = :sellerId";
  ...
  <nav>
	...
	<section class="container" style=" display: flex;">
		<div class="side-nav" style="width: 250; height: auto;">
			<ul>
               <li class="active"><a href="confirmOrder2.php">Received Orders</a></li>
    ...
    <div class="product-orders">
      ...
      <div class="order-container">
        <div class="order-header">Orders Pending</div>
                                ...
                                <ul>
                                    <li>
                                        <div class="purchase-info">
                                           <button type="button" name="pressMe" class="btn" data-order-id="<?php echo $orders['fld_order_id']; ?>" onclick="updateStatus(this)">Confirm Order</button>
                                        </div>
